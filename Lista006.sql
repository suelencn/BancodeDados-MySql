...
(5,'Livro - 512',5,1,2,15.5),
(6,'Livro - 512',5,1,2,20.5),
(7,'Livro - 512',5,1,2,10.5),
...
select l.titulo, e.nome, es.nome, a.nome from livro as l, editora as e, estilo as es, autor as a
where  l.id_editora = e.id_editora 
and l.id_estilo = es.id_estilo
and l.id_autor = a.id_autor;

select l.titulo, e.nome from livro as l, editora as e
where l.id_editora = e.id_editora
and e.telefone = '123345';

select l.titulo, a.nome from livro as l, autor as a
where l.id_autor = a.id_autor
and a.idade = 35;

select l.titulo, a.nome, e.nome from livro as l, editora as e, autor as a
where l.id_autor = a.id_autor
...
where l.id_autor = a.id_autor
and l.id_editora = e.id_editora
and (a.nome like 'Dan Brown' or e.telefone = '123345');

select l.titulo, e.nome from livro as l, estilo as e
where l.id_estilo = e.id_estilo
and e.nome = 'Romance';

select l.titulo, e.nome from livro as l, estilo as e, editora
where l.id_estilo = e.id_estilo
and l.id_editora = editora.id_editora
